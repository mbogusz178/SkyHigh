            ...
            <div>
                <div className="jumbotron mt-1">
                    <div className="container text-center mt-3">
                        ...
                        <input id="countryInput" className={('country' in this.state.errors) ? "form-control form-control-lg mt-3 is-invalid" : "form-control form-control-lg mt-3"} placeholder="Kraj" type="text" value={this.props.country} onChange={this.onCountryChange} />
